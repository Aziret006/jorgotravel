import { JORGO_EASTERN, jorgoMedia } from '@/lib/jorgo-media'
...
export type MapDestination = {
  ...
  lng: number
  images: string[]
  /** Видео локации — проигрывается при наведении курсора */
  video?: string
  description: string
}
...
export const MAP_DESTINATIONS: MapDestination[] = [
  ...
  },
  {
    ...
    lng: 76.47,
    description:
      'Затерянное озеро в скальном каньоне у границы с Китаем — цель самой атмосферной джип-экспедиции.',
  ...
  },
  {
    ...
    video: productVideo('Уйулган таш Каркыра (4).mp4'),
    images: [
      'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=900&q=80',
      'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?auto=format&fit=crop&w=900&q=80',
      'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=900&q=80',
  ...
  },
  {
    ...
    video: productVideo('Площадь (4).mp4'),
  ...
  },
  {
    ...
    lng: 74.482,
    description:
      'Национальный парк в 40 км от Бишкека — водопады, еловые леса и треккинг к пику Учитель.',
  ...
  },
  {
    ...
    video: productVideo('Каракол церковь (4).mp4'),
